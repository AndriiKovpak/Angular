...
@Component({
  selector: 'app-company-test-questions',
  templateUrl: './company-test-questions.component.html',
  styleUrls: ['./company-test-questions.component.scss']
})
export class CompanyTestQuestionsComponent implements OnInit,AfterViewInit {
  //for paging
  pageIndex: number = 1;
  pageSize: number = 10;
  count: number = 5;
