...
@Component({
  selector: 'app-test-questions-answers',
  templateUrl: './test-questions-answers.component.html',
  styleUrls: ['./test-questions-answers.component.scss'],
})
export class TestQuestionsAnswersComponent implements OnInit ,AfterViewInit{
  //for paging
  pageIndex: number = 1;
  pageSize: number = 10;
  count: number = 5;
